(function (t) {
    ...
    "56d7": function (t, e, a) {
        ...
        var u = c.exports,
            ...
            A = y,
            k = (a("f6bc"), Object(l["a"])(A, f, v, !1, null, "7efb1074", null));
        ...
        var w = k.exports,
            ...
            P = N,
            j = (a("74e0"), Object(l["a"])(P, C, _, !1, null, "46aeedd0", null));
        j.options.__file = "Register.vue";
        var H = j.exports,
            L = function () {
                var t = this,
                    e = t.$createElement,
            ...
            K = M,
            V = (a("ed38"), Object(l["a"])(K, L, q, !1, null, "14f79580", null));
        V.options.__file = "History.vue";
        var F = V.exports,
            B = function () {
                var t = this,
                    e = t.$createElement,
            ...
            R = a("2f62"),
            Y = {
                computed: Object(G["a"])({}, Object(R["b"])(["userList"])),
                data: function () {
                    return {
                        valid: !1,
                        email: "",
                ...
                methods: {
                    checkLogin: function () {
                        ...
                        0 == r.length ? this.snackbar = !0 : (this.$store.state.loggedinUserEmail = this.email, this.$router.push("/home"))
                    }
                },
                created: function () {}
            },
            T = Y,
            W = (a("039a"), Object(l["a"])(T, B, z, !1, null, null, null));
        W.options.__file = "Login.vue";
        var $ = W.exports,
            Q = function () {
                var t = this,
                    e = t.$createElement,
            ...
            Z = J,
            tt = (a("5ede"), Object(l["a"])(Z, Q, X, !1, null, "6f5dca12", null));
        tt.options.__file = "NavDrawer.vue";
        var et = tt.exports,
            at = function () {
                var t = this,
                    e = t.$createElement,
                ...
                return n("div", {
                    ...
                    staticClass: "pt-3"
                }, [t._v(t._s(t._f("initcap")(t.name)) + " profile")]), n("v-form", [n("v-container", [n("v-layout", {
                    attrs: {
                        row: "",
                        wrap: ""
                    }
                ...
                }, [t._v("Submit Details")])], 1)], 1)])], 1)], 1), n("v-snackbar", {
                    attrs: {
                        color: "#155a18",
                        timeout: 3e3,
                        right: !0,
                ...
                }, [t._v("Profile Updated successfully")])], 1)], 1), n("div", {
                    staticClass: "col-md-5 pl-md-0 pr-md-5"
                }, [n("v-card", {
            ...
            rt = {
                ...
                created: function () {
                    var t = this,
                        ...
                        n = b()(a),
                        r = n.filter(function (e) {
                            return e[0] == t.$loginUserID[0]
                        });
                    console.log(r[0][1]), this.name = r[0][1].name, this.email = r[0][1].email, this.phno = r[0][1].phno, this.pwd = r[0][1].pwd, this.blnce = r[0][1].blnce
                },
                methods: {
                    submitDetails: function () {
                        ...
                        this.$store.commit("updateProfile", t), this.snackbar = !0
                    },
                    pickImage: function () {
                    ...
                    onFilePicked: function (t) {
                        ...
                        a.addEventListener("load", function () {
                            document.getElementsByClassName("loadImg")[0].src = a.result
                        }), a.readAsDataURL(e[0]), this.$store.commit("uploadImage", this.image)
                    }
                }
            },
            it = rt,
            st = (a("72f2"), Object(l["a"])(it, at, nt, !1, null, "126f6869", null));
        st.options.__file = "Profile.vue";
        var ot = st.exports;
        n["default"].use(d["a"]);
        var lt = new d["a"]({
                routes: [{
            ...
            ct = a("ce5b"),
            ut = a.n(ct);
        n["default"].use(R["a"]), n["default"].use(I);
        var dt = I.ref("users"),
            ft = new R["a"].Store({
                state: {
                    userList: {},
                ...
                mutations: {
                    ...
                    updateMoney: function (t, e) {
                        dt.child(t.loggedInID).update({
                            blnce: e
                        })
                    },
                    addHistory: function (t, e) {
                        dt.child(t.loggedInID).child("history").push(e)
                    },
                    getFirebaseDatabase: function (t) {
                        dt.on("value", function (e) {
                            t.userList = e.val()
                        })
                    },
                    getHistoryData: function (t) {
                        dt.child(t.loggedInID).child("history").on("value", function (e) {
                            t.historyData = e.val()
                        })
                    },
                    clearAllHistory: function (t) {
                        dt.child(t.loggedInID).child("history").remove()
                    },
                    ...
                    uploadImage: function (t, e) {
                        var a, n;
                        dt.child(t.loggedInID).push(e).then(function (t) {
                            return n = t.key, n
                        }).then(function (a) {
                            var n = e.name,
                                r = n.slice(n.lastIndexOf("."));
                            return O.a.storage().ref("users/" + t.loggedInID + "/" + a + r).put(e)
                        }).then(function (e) {
                            return a = e.metadata.downloadURLs[0], dt.child(t.loggedInID).child(n).update({
                                imageUrl: a
                            })
                        }).catch(function (t) {
                            console.log(t)
        ...
        var pt = "",
            mt = pt;
        a("bf40");
        n["default"].use(ut.a), n["default"].config.productionTip = !1, n["default"].use(R["a"]), new n["default"]({
            router: lt,
            store: vt,
            filter: mt,
            render: function (t) {
...
//# sourceMappingURL=app.ddacfb03.js.map